        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('information.create') }}">Cập nhật thông tin
                            website</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('chaptertranh.create') }}">Thêm chapter truyện
                        tranh</a>
                    <a class="dropdown-item" href="{{ route('chaptertranh.index') }}">Liệt kê chapter truyện
                        tranh</a>
                </div>
