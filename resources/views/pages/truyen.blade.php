...
<div class="row">
	...
	<div class="col-md-9">
		...
		<div class="row">
			...
			<div class="col-md-5">
				 ...
				 <img class="card-img-top" src="{{asset('uploads/truyen/'.$truyen->hinhanh)}}" >
	...
	<div class="col-md-3">
		...
		<div class="row mt-2">
				...
				<div class="col-md-5"><img class="img img-responsive" width="100%" class="card-img-top" src="{{asset('uploads/truyen/'.$noibat->hinhanh)}}" alt="{{$noibat->tentruyen}}"></div>
		...
		<div class="row mt-2">
				...
				<div class="col-md-5"><img class="img img-responsive" width="100%" class="card-img-top" src="{{asset('uploads/truyen/'.$xemnhieu->hinhanh)}}" alt="{{$xemnhieu->tentruyen}}"></div>
		...
		<div class="row mt-2">
				...
				<div class="col-md-5"><img class="img img-responsive" width="100%" class="card-img-top" src="{{asset('uploads/truyen/'.$tranh->hinhanh)}}" alt="{{$tranh->tentruyen}}"></div>
